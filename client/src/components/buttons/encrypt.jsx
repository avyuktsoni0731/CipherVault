...
const EncryptButton = () => {
  ...
  return (
    <motion.button
      ...
      className="group relative overflow-hidden rounded-lg border-[1px] border-[#737373] bg-[#404040] px-4 py-2 font-mono font-medium uppercase text-[#D4D4D4] transition-colors hover:text-[#A5B4FC]"
    >
